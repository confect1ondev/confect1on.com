...
// Add loaded class as soon as DOM is interactive
    ...
    navigationLinks[i].addEventListener('click', function() {
        ...
        for(let i = 0; i < pages.length; i++) {
            if(this.innerHTML.toLowerCase() == pages[i].dataset.page) {
                ...
                // Re-initialize blog if navigating to blog page
                if(pages[i].dataset.page === 'blog' && typeof initializeBlog === 'function') {
